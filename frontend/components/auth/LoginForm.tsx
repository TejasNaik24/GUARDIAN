    ...
    <>
      ...
      <div className="w-full max-w-md">
        ...
        <button
          ...
          className="w-full mt-4 py-3 bg-white border-2 border-gray-300 text-gray-700 rounded-lg font-semibold hover:bg-gray-50 hover:border-gray-400 transition-all cursor-pointer flex items-center justify-center gap-3"
        >
        ...
        <button
          onClick={onGuestMode}
          className="w-full mt-3 py-3 bg-gray-100 text-gray-700 rounded-lg font-semibold hover:bg-gray-200 transition-colors cursor-pointer"
        >
          Continue as Guest
        </button>
